...
function Footer() {
  ...
  return (
    <footer>
      <div className='bg-[#443426] flex flex-col justify-evenly py-6 md:flex-row md:items-start'>
        ...
        <div className='bg-[#443426] flex  flex-col justify-center text-center my-4 md:text-start'>
          ...
          <h3 className='text-lg font-bold text-white md:py-4  py-2'>Conoce más acerca de la iglesia <NavLink to="/about" className={"hover:text-[#bd8351]"}>AQUÍ</NavLink></h3>
        </div>
