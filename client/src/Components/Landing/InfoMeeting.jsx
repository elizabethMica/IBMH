    ...
    <section className='  mt-8 flex justify-center items-center'>
      ...
      <div className='flex flex-col md:flex-row px-8 md:gap-1 md:justify-center'>
        ...
        <div className='flex flex-col justify-center items-center md:mx-8'>
          <FaChurch size={30} color={"black"} className='mb-2 md:mb-0' />
        ...
        <div>
          <h3 className='font-semibold text-xl m-8 text-center md:text-3xl'>También puedes acceder al contenido de la iglesia en:</h3>
