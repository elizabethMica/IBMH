...
function FormContact() {
  ...
  return (
    <form onSubmit={(event)=>handleSubmit(event)} className='bg-[#be8552] md:rounded-lg my-8 py-4 md:py-6 justify-center items-center flex  flex-col gap-2 md:gap-4 md:w-3/6 w-full'>
